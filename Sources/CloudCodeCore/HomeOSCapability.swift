...
public enum HomeOSCapabilityLayer {
    public static func snapshots(from records: [CapabilityRecord]) -> [HomeOSCapabilitySnapshot] {
        ...
        return [
            ...
            .init(id: .shell, status: status("cli.runtime"), detail: "Bounded ios_system command runtime is exposed only after cli.runtime proves runtime symbols, dictionaries, frameworks, and the complete packaged P0 catalog. A bare execution.ios_system symbol is insufficient.", backingCapabilities: ["cli.runtime"]),
            ...
            .init(id: .script, status: .unavailable, detail: "No script interpreter is inferred from the basic ios_system command runtime. Script capability stays unavailable until an explicit verified interpreter command is packaged.", backingCapabilities: []),
