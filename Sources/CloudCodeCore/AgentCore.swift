...
public actor AgentCore {
    ...
    private static func toolArgumentSpec(for name: String) -> ToolArgumentSpec? {
        ...
        case "gui.feedSample":
            return ToolArgumentSpec(properties: ["direction": "string", "count": "number"], required: ["direction", "count"])
        case "gui.verify":
