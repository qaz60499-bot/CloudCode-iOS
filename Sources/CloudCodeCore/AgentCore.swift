...
public actor AgentCore {
                            ...
                            if let appListSignature, completedAppListSignatures.contains(appListSignature) {
                               ...
                               !Self.allowsImmediateSemanticRepeat(name: name) {
                                ...
                                do {
                                    ...
                                    session.messages.append(ChatMessage(role: .tool, content: content, providerMetadata: ["tool_call_id": providerCallID, "tool_name": name, "provider_tool_name": providerToolName]))
                                    if result.success, (name == "gui.openApp" || name == "gui.openAppObserve" || name == "apps.launch"),
                                    ...
                                    if (name == "gui.screenshot" || name == "gui.swipeSequence" || name == "gui.navigateBack" || name == "gui.runStructuredPlan" || name.hasSuffix("Observe")), result.success,
    ...
    static func semanticToolScope(name: String, arguments: [String: String]) -> String? {
        ...
        case "gui.openApp", "gui.openAppObserve":
            ...
            return "gui:\(bundleID)"
        case "gui.tap", "gui.type", "gui.scroll", "gui.swipe", "gui.swipeSequence", "gui.navigateBack", "gui.tapObserve", "gui.typeObserve", "gui.scrollObserve", "gui.swipeObserve", "gui.tapElementObserve", "gui.typeElementObserve", "gui.runStructuredPlan":
