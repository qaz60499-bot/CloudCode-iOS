                                ...
                                do {
                                    ...
                                    if name == "gui.focusComposerObserve" {
                                        verifiedMessagingComposerFocus = result.success
                                            && (result.payload["focusVerified"] == "true" || result.payload["keyboardLikely"] == "true")
                                    } else if result.success,
